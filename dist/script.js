...
(function ($) {
  ...
  $(document).ready(function () {
    pswp = $('.pswp')[0]; // Find all a > img

    var aImg = $('a[href$=".pdf"] > img');
    aImg.each(function () {
      $(this).parent().addClass('disable-ps');
    });
    itemSources = $('article:not(.excerpt) a:not(.disable-ps) > img'); // Preload images
    ...
    $(window).on('load', function () {
      ...
      var scrollTo = null; // Initial active page
...
__webpack_require__(/*! /mnt/d/Sites/wordpress/wp-content/themes/psba-manila/src/js/script.js */"./src/js/script.js");
module.exports = __webpack_require__(/*! /mnt/d/Sites/wordpress/wp-content/themes/psba-manila/src/scss/style.scss */"./src/scss/style.scss");
